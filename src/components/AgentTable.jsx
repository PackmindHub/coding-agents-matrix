...
const AgentTable = ({ agents, sortConfig, onSort }) => {
  ...
  const columns = [
    ...
    { key: 'mcpSupport', label: 'MCP', sortable: true, cellType: 'badge', tooltip: 'Support Model Context Protocol (MCP) for enhanced context sharing' },
    { key: 'customRules', label: 'Custom Rules', sortable: true, cellType: 'badge', tooltip: 'Ability to define custom rules and guidelines for the agent in their own structure' },
    { key: 'agentsMdSupport', label: 'AGENTS.md', sortable: true, cellType: 'badge', tooltip: 'Support for AGENTS.md files' },
